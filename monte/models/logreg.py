...
import sys
sys.path.append('../..')
from monte.util import logsumexp,unhot,onehot
from monte.models import backprop
...
class Logreg(object):
    ...
    def grad(self, features, labels, weightcost):
        ...
        # compute the probabilities of each class of a sample
...
class LogregNNIsl(object):
    """ Nonlinear logistic regression using a backprop network with one 
        sigmoid hidden layer. 

        Similar to class Logreg. 
    """
